...
public void inserir(ProdutoDTO produDTO) throws NegocioException {
    Produto produto = this.toEntity(produDTO);
    ...
    public void alterar (ProdutoDTO produtoDTO) throws NegocioException {
        ...
        try {
            if (produtoDAO.buscarPorCodigo(produto.getCodigo())== null){
                throw new NegocioException("Não existe esse produto");
            }
            produtoDAO.beginTransaction();
    ...
    public void excluir (int codigo) throws NegocioException {
        try {
            ...
            produtoDAO.rollbackTransaction();
            throw new NegocioException("Erro ao exluir o produto--"+ ex.getMessage());
    ...
    public List<ProdutoDTO> pesquisaParteNome(String parteNome) throws NegocioException{
        try {
            ...
            throw new NegocioException("Erro ao pesquisar produto pelo nome --"+ ex.getLocalizedMessage()); 
        }
    }
    public List<ProdutoDTO> pesquisaProdutoAbaixoEstoqueMinimo() throws NegocioException{
        try {
            return this.toDTOAll(produtoDAO.buscarProdutoAbaixoEstoqueMinimo());
        } catch (PersistenciaException ex) {
           throw new NegocioException("Erro ao pesquisa produto abaixo do estoque minimo" + ex.getMessage()); 
    ...
    public ProdutoDTO pesquisaCodigo (int codigo) throws NegocioException {
        ...
        throw new NegocioException("Erro ao pesquisa produto pelo codigo--" + ex.getMessage());
